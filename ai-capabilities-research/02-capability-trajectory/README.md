...
| Model Transition | Timeframe | Improvement | Benchmark |
|------------------|-----------|-------------|-----------|
| GPT-4o → GPT-5 | 14 months | >2x | GDPval expert parity |
...
|--------|------------|-----------|
| McKinsey | $4.4 trillion/year | Annual potential |
| PWC | $15.7 trillion | Global GDP by 2030 |
| IMF | 0.6% productivity growth boost | Annual |
