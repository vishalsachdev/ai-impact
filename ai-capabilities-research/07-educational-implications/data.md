...
# Educational Implications: Detailed Data
...
- Require drafts, revisions, and reflection
...
- Identify limitations of approach
...
- Dedicated AI literacy requirement
- Typically 3 credits
- Universal coverage

**Model B: Embedded Integration**
- AI modules in existing courses
...
- AI detection tools unreliable (high false positive/negative rates)
- Stylistic analysis limited
- Paraphrased content difficult to detect

**Recommended Approach**:
- Focus on learning objectives, not policing
- Assess what students can do, not just produce
- Use verification (oral defense) over detection
- Clear expectations reduce violations
...
- Analytical methods suggested by AI
- Code written by AI

**Inappropriate Uses**:
- Fabricating data or sources
- Misrepresenting AI work as human
- Using AI to bypass ethical review

### Attribution in Publications

**Emerging Standards**:
- Disclose AI assistance in methods
- Specify which sections AI-assisted
- Human responsibility for content
- No AI as co-author (generally)

### Reproducibility Considerations

- Document AI tools and versions used
- Include prompts for critical analyses
- Verify AI-generated code/analysis
- Human verification of key findings
...
- AI literacy coordinator (new position)
...
- Adapt assessments to ensure validity
- Integrate AI literacy progressively
- Update curriculum continuously
