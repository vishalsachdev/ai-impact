...
- **Arguments**:
  1. Complementarity with existing resources
  2. Differential sectoral impacts
  3. Implementation capacity gaps
...
1. **Country coverage**: Most countries not included in studies
2. **Within-country inequality**: Urban vs rural, rich vs poor regions
3. **Longitudinal data**: Limited multi-year tracking
4. **Usage quality**: Access vs effective usage
5. **Economic outcomes**: Impact measurement lacking
6. **Causal mechanisms**: Correlation vs causation unclear
